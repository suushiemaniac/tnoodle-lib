...
public class ThreeByThreeCubePuzzle extends CubePuzzle {
    ...
    public PuzzleStateAndGenerator generateRandomMoves(Random r, String firstAxisRestriction, String lastAxisRestriction) {
        ...
        return solveRandomState(randomState, firstAxisRestriction, lastAxisRestriction);
    }

    public PuzzleStateAndGenerator solveRandomState(String randomState, String firstAxisRestriction, String lastAxisRestriction) {
    ...
    public PuzzleStateAndGenerator solveRandomState(String randomState) {
        return solveRandomState(randomState, null, null);
    }
